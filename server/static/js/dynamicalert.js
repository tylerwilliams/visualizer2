   ...
   var pub = {
         /* 
          ...
          return function(message, opts){  
            ...
            var html = '<div id="'+id+'" class="fl-notification alert fade in ' + 
                               'alert-'+settings.mode + blockMessageClass +" "+ settings.extraClasses+ '" data-alert="alert">'+
                               '<a class="close" href="#" data-dismiss="alert">×</a><p><strong>'+capitalize(settings.mode)+':</strong> ' + message + '</p>' + 
                               alertActions + '</div>';
      ...
      notifyYesNo: function(message, opts){
          ...
          {
              actions: [
                {label: "Yes", defaultAction: true, callback: opts.yesAction},
                {label: "No",                       callback: opts.noAction}
              ]
          };
      ...
      notifyOk: function(message, opts){
          ...
          {
              actions: [
                {label: "Ok", defaultAction: true, callback: opts.okAction}
              ]
          };
